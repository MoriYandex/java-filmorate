...
class FilmControllerTests {
    ...
    private final FilmService filmService = new FilmService(new DbFilmStorage(new JdbcTemplate(), new DbGenreStorage(new JdbcTemplate())), new DbUserStorage(new JdbcTemplate(), new DbFriendshipStorage(new JdbcTemplate())), new DirectorDbStorage(new JdbcTemplate()));
