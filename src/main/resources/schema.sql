...
DROP TABLE T008_DIRECTORS IF EXISTS;
...
CREATE TABLE t007_links_t001_t008 (
t007_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
t001_id integer NOT NULL,
t008_id integer NOT NULL
);

CREATE TABLE t008_directors (
  t008_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  t008_name varchar NOT NULL
);
...
COMMENT ON TABLE t008_directors IS 'Режиссёры фильмов';

COMMENT ON COLUMN t008_directors.t008_id IS 'ИД Режиссёра';

COMMENT ON COLUMN t008_directors.t008_name IS 'Имя Режиссёра';

COMMENT ON TABLE t007_links_t001_t008 IS 'Соответствие фильмов и режиссеров';

COMMENT ON COLUMN t007_links_t001_t008.t007_id IS 'ИД';

COMMENT ON COLUMN t007_links_t001_t008.t001_id IS 'ИД фильма';

COMMENT ON COLUMN t007_links_t001_t008.t008_id IS 'ИД режиссера';

ALTER TABLE t007_links_t001_t008 ADD CONSTRAINT fk_t007_t001 FOREIGN KEY (t001_id) REFERENCES t001_films (t001_id) ON DELETE CASCADE;

ALTER TABLE t007_links_t001_t008 ADD CONSTRAINT fk_t007_t008 FOREIGN KEY (t008_id) REFERENCES t008_directors (t008_id) ON DELETE CASCADE;
...
ALTER TABLE t001_films ADD CONSTRAINT fk_t001_t008 FOREIGN KEY (t008_id) REFERENCES t008_directors (t008_id) ON DELETE SET NULL;
