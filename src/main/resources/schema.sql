...
CREATE TABLE t011_feeds (
  t011_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  t011_timestamp timestamp,
  t002_id INTEGER,
  t011_event_type enum('LIKE', 'REVIEW', 'FRIEND'),
  t011_operation enum('ADD', 'REMOVE', 'UPDATE'),
...
ALTER TABLE t007_links_t001_t005 ADD CONSTRAINT fk_t007_t001 FOREIGN KEY (t001_id) REFERENCES t001_films (t001_id) ON DELETE CASCADE;
ALTER TABLE t007_links_t001_t005 ADD CONSTRAINT fk_t007_t005 FOREIGN KEY (t005_id) REFERENCES t005_genres (t005_id);
...
ALTER TABLE t011_feeds ADD CONSTRAINT fk_t011_t002 FOREIGN KEY (t002_id) REFERENCES t002_users (t002_id) ON DELETE CASCADE;